...
model  =  pickle.load(open("risk_predictor.pkl","rb"))
...
exercise=st.slider("Exersise Day per Week",0,7,3)
...
# st.write(encoders['diet'].classes_)
# st.write(encoders['diet'].transform([diet])[0])
